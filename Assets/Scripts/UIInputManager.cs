...
public class UIInputManager:MonoBehaviour
{
   ...
   {
      //add by chen
      string userInfo = "{\"username\": \"" + emailFieldLogin.text + "\", \"password\":\"" + passwordFieldLogin.text + "\"}";
      SendMessageUpwards("JsSiginIn", userInfo);
      ////////////////////////////////////////////////////////////

      _unauthInterface.SetActive(false);
      _loading.SetActive(true);
      Debug.Log("onLoginClicked: " + emailFieldLogin.text + ", " + passwordFieldLogin.text);
      // bool successfulLogin =  _authenticationManager.JsSiginIn(emailFieldLogin.text, passwordFieldLogin.text);
